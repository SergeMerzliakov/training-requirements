...
The significant pathways are shown in the table below. All have very close enrichment scores - from 1.88 [TODO] for the first gene to 1.72 for the first 100 pathways. So the the most significant pathways are too similarly expressed to make meaningful distinctions between them.
...
mean_counts <- apply(raw_counts[,1:ncol(raw_counts)], 1, mean)
variance_counts <- apply(raw_counts[,1:ncol(raw_counts)], 1, var)
