...
kable(rankedMeanDensity[1:5,c(1,12)], col.names=c("Country", "Average Population Density"), caption="Top 10 Nations By Population Density (1962-2007)", align = "lc", format = "html", table.attr = "style='width:55%;margin-left:15%'")
```
