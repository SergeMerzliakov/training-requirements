...
# |   |   | O |
#  --- --- ---
board_setup_1 <- function(rand_seed) {
  game <- new_game(rand_seed)
...
# |   |   | O |
#  --- --- ---
board_setup_2 <- function(rand_seed) {
  game <- new_game(rand_seed)
...
# |   |   |   |
#  --- --- ---
board_setup_3 <- function(rand_seed) {
  game <- new_game(rand_seed)
...
# |   |   |   |
#  --- --- ---
board_win_setup_1 <- function(rand_seed) {
  game <- new_game(rand_seed)
